...
public:
    ...
    void RegisterCharts() {
        ...
        RegisterFunctor<GraphFactory, RenderTs...>(
...
private:
    ...
    template<typename... RenderTs>
    static std::shared_ptr<GraphFactory> CreateChartFactoryFn(std::shared_ptr<RenderTs>... renders) {
        QVector<std::shared_ptr<GraphFactory>> v{ renders... };
        return std::make_shared<GraphFactory>(v);
    }
};
